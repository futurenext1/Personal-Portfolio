      ...
      <div className="border-t border-gray-200">
        <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
          <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
            ...
            <button className="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Search</button>
            <p className="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci cumque modi amet laborum exercitationem incidunt quae temporibus alias rem blanditiis provident, accusantium possimus totam praesentium!
              <br className="lg:block hidden" />Lorem ipsum dolor sit amet.
            </p>
          </div>
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eveniet iure enim ipsum odit, sapiente architecto adipisci. Similique molestiae veritatis quis labore in consequatur.
          </span>
        </div>
      </div>
    </footer>
